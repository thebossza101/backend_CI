...
var HTML = '';
  ...
  //alert(document.getElementById("Master_ch").checked = true);
...
/*if(document.getElementById("txtMaster").disabled == true){ //here
        alert("disabled");
    }else{
        alert("enable");
    }*/
...
//	alert(document.getElementById("txtMaster").disabled == true);
...
function toggleVis(btn){
	...
	//alert(mode);
	//txtMaster	=	document.getElementbyId('txtMaster').disabled == false;
	
	

   // $('#Master_ch').click(function () {
